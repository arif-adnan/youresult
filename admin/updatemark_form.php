    ...
    <header>
      <nav>
        <div class="row clearfix">
            ...
            <li><a href="admindash.php"><b>Admin Dashboard</b></a></li>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
              <span> <h4 class="h_3">Mid Term Exam</h4></span>
             <tr>
                <th>Bangla</th>   <th> English </th> <th>Math</th>
             </tr>
             <tr>
                 <td>
                <input type='text' name='bangla1' value="<?php echo $data['u_bangla1']; ?>" class="th" required/></td>
         ...
         <table class="table4">
             ...
             <tr>
                 <td><input type='text' name='bangla2' value="<?php echo $data['u_bangla2']; ?> " class="th" required/></td>
